<template>
  <div class="about">
     <div class="item" style="background: yellow">可斯柯达</div>
     <div class="item" style="background: blue">临水临电了</div>
     <div class="item">开始打开</div>
     <div class="item">SDK</div>
     <div class="item">临水临电</div>
